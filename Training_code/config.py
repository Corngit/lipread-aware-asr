...
#project structure
args["CODE_DIRECTORY"] = "/home/hymcorn/avsr/deep_avsr"   #absolute path to the code directory
args["DATA_DIRECTORY"] = "/home/hymcorn/avsr/ChineseData"   #absolute path to the data directory
args["DEMO_DIRECTORY"] = "/home/hymcorn/avsr/deep_avsr/audio_visual/demo"
args["PRETRAINED_MODEL_FILE"] = "/audio_visual/final/models/pretrain_037w-step_0910-wer_0.217.pt"     #relative path to the pretrained model file
args["TRAINED_MODEL_FILE"] = "/audio_visual/final/models/fold1-step_0585-cer_0.322-wer_0.725.pt"   #relative path to the trained model file
args["TRAINED_LM_FILE"] = "/home/hymcorn/avsr/pretrained_weight/language_model.pt"  #absolute path to the trained language model file
args["TRAINED_FRONTEND_FILE"] = "/home/hymcorn/avsr/pretrained_weight/visual_frontend.pt" #absolute path to the trained visual frontend file
...
args["PRETRAIN_NUM_WORDS"] = 37  #number of words limit in current curriculum learning iteration
...
args["STEP_SIZE"] = 256   #number of samples in one step (virtual epoch)
args["NUM_STEPS"] = 300 #maximum number of steps to train for (early stopping is used)
...
args["INIT_LR"] = 3e-6  #initial learning rate for scheduler
